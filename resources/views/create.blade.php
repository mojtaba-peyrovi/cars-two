...
<link rel="stylesheet" href="{{ URL::asset('backend/css/bootstrap-responsive.min.css') }}" />
<!-- <link rel="stylesheet" href="backend/css/colorpicker.css" /> -->
<link rel="stylesheet" href="{{ URL::asset('backend/css/colorpicker.css') }}" />
<!--<link rel="stylesheet" href="backend/css/datepicker.css" /> -->
<link rel="stylesheet" href="{{ URL::asset('backend/css/datepicker.css') }}" />
<!--<link rel="stylesheet" href="backend/css/uniform.css" /> -->
<link rel="stylesheet" href="{{ URL::asset('backend/css/uniform.css') }}" />
<!--<link rel="stylesheet" href="backend/css/select2.css" /> -->
<link rel="stylesheet" href="{{ URL::asset('backend/css/select2.css') }}"/>
<!--<link rel="stylesheet" href="backend/css/matrix-style.css" /> -->
<link rel="stylesheet" href="{{ URL::asset('backend/css/matrix-style.css') }}" />
<!-- <link rel="stylesheet" href="backend/css/matrix-media.css" /> -->
<link rel="stylesheet" href="{{ URL::asset('backend/css/matrix-media.css') }}" />
<!-- <link rel="stylesheet" href="backend/css/bootstrap-wysihtml5.css" /> -->
<link rel="stylesheet" href="{{ URL::asset('backend/css/bootstrap-wysihtml5.css') }}" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Admin Area</a></h1>
</div>
<!--close-Header-part-->
...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class=""><a title="" href="#"><i class="icon-cog" aria-hidden="true"></i> <span class="text">Settings</span></a></li>
...
<div id="content-header">
  ...
  <h1>CARS DATABASE ADMIN AREA</h1>
</div>
<div class="container-fluid">
  <hr>
  <div  class="quick-actions_homepage">
    <ul class="quick-actions">
      <li class="bg_lb"> <a href="#"> <i class="icon-plus"></i> Add a car </a> </li>
      <li class="bg_lg"> <a href="#"> <i class="icon-table"></i> Masterfile </a> </li>
      <li class="bg_ly"> <a href="#"> <i class=" icon-globe"></i> Web Marketing </a> </li>
      <li class="bg_lo"> <a href="#"> <i class="icon-globe"></i> Delete a car </a> </li>
        ...
        <div class="widget-content nopadding">
          <form action="{{route('store')}}" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              <label class="control-label" name="make">Car Make :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Car Make" name="make"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Car Model :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Car Model" name="model" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Car Trim :</label>
              <div class="controls">
                <input type="text"  class="span11" placeholder="Car Trim" name="trim" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Car Price :</label>
              <div class="controls">
                <input type="text"  class="span11" placeholder="Car Price" name="price" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Car dealer :</label>
              <div class="controls">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="year" placeholder="Car year" />
              </div>
          </div>
            <div class="control-group">
              <label class="control-label">Mileage :</label>
              <div class="controls">
                <input type="text" class="span11" name="mileage" placeholder="Car mileage"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Engine :</label>
              <div class="controls">
                <input type="text" class="span11" name="engine" placeholder="Car engine"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">transmission :</label>
              <div class="controls">
                <input type="text" class="span11" name="transmission" placeholder="transmission type"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Consumption(Litre/Km) :</label>
                <div class="controls">
                  <input type="text" class="span11" name="consumptionCity" placeholder="City"/>
                  <span><input type="text" class="span11" name="consumptionHwy" placeholder="Highway"/></span>
                </div>
            </div>
            <div class="control-group">
              <label class="control-label">Fuel :</label>
              <div class="controls">
                <input type="text" class="span5" name="fuel" placeholder="Fuel type"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Description</label>
              <div class="controls">
                <textarea class="span11" name="desc" placeholder="About this car" cols="8" rows="10"></textarea>
              </div>
            </div>
...
<script src="{{ URL::asset('backend/js/jquery.ui.custom.js')}}"></script>
<!--<script src="backend/js/bootstrap.min.js"></script>-->
<script src="{{ URL::asset('backend/js/bootstrap.min.js')}}"></script>
<!--<script src="backend/js/bootstrap-colorpicker.js"></script>-->
<script src="{{ URL::asset('backend/js/bootstrap-colorpicker.js')}}"></script>
...
<script src="{{ URL::asset('backend/js/jquery.toggle.buttons.js')}}"></script>
<!--<script src="backend/js/masked.js"></script>-->
<script src="{{ URL::asset('backend/js/masked.js')}}"></script>
<!--<script src="backend/js/jquery.uniform.js"></script>-->
<script src="{{ URL::asset('backend/js/jquery.uniform.js')}}"></script>
...
<script src="{{ URL::asset('backend/js/matrix.js')}}"></script>
<!--<script src="backend/js/matrix.form_common.js"></script>-->
<script src="{{ URL::asset('backend/js/matrix.form_common.js')}}"></script>
<!--<script src="backend/js/wysihtml5-0.3.0.js"></script>-->
<script src="{{ URL::asset('backend/js/wysihtml5-0.3.0.js')}}"></script>
<!--<script src="backend/js/jquery.peity.min.js"></script>-->
<script src="{{ URL::asset('backend/js/jquery.peity.min.js')}}"></script>
<!--<script src="backend/js/bootstrap-wysihtml5.js"></script>-->
<script src="{{ URL::asset('backend/js/bootstrap-wysihtml5.js')}}"></script>
<script>
